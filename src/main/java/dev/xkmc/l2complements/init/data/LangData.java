...
public class LangData {
	...
	public enum IDS {
		...
		CAPTURED_WIND("tooltip.misc.captured_wind", "Obtained by flying faster than %s blocks per second while having Wind Bottle in hand or inventory.", 1),
		...
		ETERNAL_ANVIL("tooltip.misc.eternal_anvil","Does not consume player xp on all operations. Output has no repair penalty.",1),
		...
		SCULKIUM_ARMOR("tooltip.tool.sculkium_armor", "Cancel all vibrations emitted by wearer.", 0),
