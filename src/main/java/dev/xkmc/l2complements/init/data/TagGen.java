...
public class TagGen {
	...
	public static void onEffectTagGen(RegistrateTagsProvider.IntrinsicImpl<MobEffect> pvd) {
		...
		pvd.addTag(SKILL_EFFECT)
				...
				.addOptional(new ResourceLocation("goety", "iron_hide"))
				.addOptional(new ResourceLocation("goety", "chill_hide"))
				.addOptional(new ResourceLocation("goety", "shadow_walk"))
				.addOptional(new ResourceLocation("goety", "soul_hunger"))
				.addOptional(new ResourceLocation("goety", "electrified"))
				.addOptional(new ResourceLocation("goety", "impaired"))
