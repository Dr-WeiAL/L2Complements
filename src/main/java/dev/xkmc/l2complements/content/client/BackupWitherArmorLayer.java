...
public class BackupWitherArmorLayer extends EnergySwirlLayer<WitherBoss, BackupWitherBossModel<WitherBoss>> {
	...
	public static final ModelLayerLocation WITHER_ARMOR = new ModelLayerLocation(new ResourceLocation(L2Complements.MODID, "wither"), "armor");

	private static final ResourceLocation WITHER_ARMOR_LOCATION = new ResourceLocation(L2Complements.MODID, "textures/entity/wither_armor.png");
